package com.xuanyuan.springboot.test.demo.function;
...
public class JwtOperator {
    ...
    public static void main(String[] args) {
        ...
        // 将我改成上面生成的token!!!
        String someToken = "eyJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEiLCJpYXQiOjE3MDk3OTU5MTQsImV4cCI6MTcxMTAwNTUxNH0.Y5xe2SEGbNbWIJxk38Tomf7yY82EBpJTs6eWMVXe100";
        ...
        String encodedPayload = "eyJpZCI6IjEiLCJpYXQiOjE3MDk3OTU5MTQsImV4cCI6MTcxMTAwNTUxNH0";
        // 测试5: 解密Payload
